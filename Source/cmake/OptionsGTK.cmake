...
# Enable interactions even if ENABLE_WEBDRIVER itself is disabled, because WebKitWebDriver is not
# parallel-installable between GTK 4 and GTK 3, so we can only use ENABLE_WEBDRIVER when building
# for GTK 4 or GTK 3, but not both. That one WebKitWebDriver must be able to drive both the
# ENABLE_WEBDRIVER and the !ENABLE_WEBDRIVER builds.
...
WEBKIT_OPTION_DEFAULT_PORT_VALUE(ENABLE_WEBDRIVER_TOUCH_INTERACTIONS PRIVATE OFF)
...
if (WEBKITGTK_API_VERSION VERSION_EQUAL "4.1")
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(WEBKIT 24 2 24)
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(JAVASCRIPTCORE 11 6 11)
elseif (WEBKITGTK_API_VERSION VERSION_EQUAL "6.0")
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(WEBKIT 23 2 19)
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(JAVASCRIPTCORE 9 6 8)
else ()
